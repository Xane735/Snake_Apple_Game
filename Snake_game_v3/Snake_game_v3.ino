...
#define JOY_X A0   // Gives X axis value (0-1023)
#define JOY_Y A1   // Gives Y axis value (0-1023)
#define BTN_PIN 2  // External button connected to D2

const int width = 20; // LCD: 20px x 4px 
const int height = 4;

int snakeX[80];       // max 80 cells x 80 cells
int snakeY[80];
int snakeLength = 3;  // Initial Snake length at start

int dirX = 1;  // Starts to move right
int dirY = 0;
...
void startGame() {
  ...
  // Starts the snake from the middle
